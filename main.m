...
for i=1:N
  ...
  [A,B,C] = linearize(x_hats(:,i),u(:,i),delta, alfa,T, control_mode);
  thetad = atan2(yd-x_hats(2,i),xd-x_hats(1,i));
  e(:,i) = [xd,yd,thetad]'-x_hats(:,i);
  if(control_mode==0)
...
lunghezza_veicolo = 1;  % Lunghezza del veicolo
larghezza_veicolo = 0.5;  % Larghezza del veicolo
